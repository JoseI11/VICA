...
include $_SERVER['DOCUMENT_ROOT'] . "/VICA/controller/categorias.controller.php";
$controlador = CategoriasController::singleton_categorias();

$_SESSION["totales"] = $controlador->getCountCategorias();
...
$_SESSION['menu'] = "categorias.php";

$_SESSION['breadcrumb'] = "Categorias";
...
<div class="container">
    ...
    <div class="modal fade" id="myModal" categoria="dialog">
    ...
    <form id="guardarDatosCategoria">
        <div class="modal fade" id="dataRegister" tabindex="-1" categoria="dialog" aria-labelledby="exampleModalLabel">
    ...
    <form id="actualidarDatosCategoria">
        <div class="modal fade" id="dataUpdate" tabindex="-1" categoria="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" categoria="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<script type="text/javascript" src="inc/js/categorias_js.js?version=<?php echo date("Y-m-d H:i:s"); ?>"></script>
