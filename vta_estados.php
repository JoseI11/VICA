...
include $_SERVER['DOCUMENT_ROOT'] . "/VICA/controller/vta_estados.controller.php";
$controlador = VtaEstadosController::singleton_vta_estados();

$_SESSION["totales"] = $controlador->getCountVtaEstados();
...
$_SESSION['menu'] = "vta_estados.php";

$_SESSION['breadcrumb'] = "Ventas - Estados";

$titlepage = "Ventas - Estados";
...
<div class="container">
    ...
    <div class="modal fade" id="myModal" vta_estado="dialog">
    ...
    <form id="guardarDatosVtaEstado">
        <div class="modal fade" id="dataRegister" tabindex="-1" vta_estado="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" vta_estado="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="nombre0" class="control-label">General:</label>
                            <select id="generalAdd" class="form-control" name="generalAdd">
                                <option type="text" value="0">NO</option>
                                <option type="text" value="1">SI</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="nombre0" class="control-label">Entrega:</label>
                            <select id="entregaAdd" class="form-control" name="entregaAdd">
                                <option type="text" value="0">NO</option>
                                <option type="text" value="1">SI</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="nombre0" class="control-label">Cobranza:</label>
                            <select id="cobranzaAdd" class="form-control" name="cobranzaAdd">
                                <option type="text" value="0">NO</option>
                                <option type="text" value="1">SI</option>
                            </select>
                        </div>
    ...
    <form id="actualidarDatosVtaEstado">
        <div class="modal fade" id="dataUpdate" tabindex="-1" vta_estado="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" vta_estado="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="nombre0" class="control-label">General:</label>
                            <select id="generalUpdate" class="form-control" name="generalUpdate">
                                <option type="text" value="0">NO</option>
                                <option type="text" value="1">SI</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="nombre0" class="control-label">Entrega:</label>
                            <select id="entregaUpdate" class="form-control" name="entregaUpdate">
                                <option type="text" value="0">NO</option>
                                <option type="text" value="1">SI</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="nombre0" class="control-label">Cobranza:</label>
                            <select id="cobranzaUpdate" class="form-control" name="cobranzaUpdate">
                                <option type="text" value="0">NO</option>
                                <option type="text" value="1">SI</option>
                            </select>
                        </div>
...
<script type="text/javascript" src="inc/js/vta_estados_js.js?version=<?php echo date("Y-m-d H:i:s"); ?>"></script>
