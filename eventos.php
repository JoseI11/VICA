...
include $_SERVER['DOCUMENT_ROOT'] . "/VICA/controller/eventos.controller.php";
$controlador = EventosController::singleton_eventos();

$_SESSION["totales"] = $controlador->getCountEventos();
...
$_SESSION['menu'] = "eventos.php";

$_SESSION['breadcrumb'] = "Eventos";
...
<div class="container">
    ...
    <div class="modal fade" id="myModal" evento="dialog">
...
<script type="text/javascript" src="inc/js/eventos_js.js?version=<?php echo date("Y-m-d H:i:s"); ?>"></script>
