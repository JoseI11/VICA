...
include $_SERVER['DOCUMENT_ROOT'] . "/VICA/controller/vta_tipos.controller.php";
$controlador = VtaTiposController::singleton_vta_tipos();

$_SESSION["totales"] = $controlador->getCountVtaTipos();
...
$_SESSION['menu'] = "vta_tipos.php";

$_SESSION['breadcrumb'] = "Ventas - Tipos";

$titlepage = "Ventas - Tipos";
...
<div class="container">
    ...
    <div class="modal fade" id="myModal" vta_tipo="dialog">
    ...
    <form id="guardarDatosVtaTipo">
        <div class="modal fade" id="dataRegister" tabindex="-1" vta_tipo="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" vta_tipo="document">
                <div class="modal-content">
                    <div class="modal-header">
    ...
    <form id="actualidarDatosVtaTipo">
        <div class="modal fade" id="dataUpdate" tabindex="-1" vta_tipo="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" vta_tipo="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<script type="text/javascript" src="inc/js/vta_tipos_js.js?version=<?php echo date("Y-m-d H:i:s"); ?>"></script>
