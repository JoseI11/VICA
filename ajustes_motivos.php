...
include $_SERVER['DOCUMENT_ROOT'] . "/VICA/controller/ajustes_motivos.controller.php";
$controlador = AjustesMotivosController::singleton_ajustes_motivos();

$_SESSION["totales"] = $controlador->getCountAjustesMotivos();
...
$_SESSION['menu'] = "ajustes_motivos.php";

$_SESSION['breadcrumb'] = "Máquinas - Modelos";

$titlepage = "Máquinas - Modelos";
...
<div class="container">
    ...
    <div class="modal fade" id="myModal" ajustes_motivo="dialog">
    ...
    <form id="guardarDatosAjustesMotivo">
        <div class="modal fade" id="dataRegister" tabindex="-1" ajustes_motivo="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" ajustes_motivo="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="nombre0" class="control-label">Impacto:</label>
                            <select id="impactoAdd" class="form-control" name="impactoAdd">
                                <option type="text" value="1">Positivo</option>
                                <option type="text" value="0">Neutro</option>
                                <option type="text" value="-1">Negativo</option>
                            </select>
                        </div>
                    </div>
                    <div class="modal-footer">
    ...
    <form id="actualidarDatosAjustesMotivo">
        <div class="modal fade" id="dataUpdate" tabindex="-1" ajustes_motivo="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" ajustes_motivo="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="nombre0" class="control-label">Impacto:</label>
                            <select id="impactoUpdate" class="form-control" name="impactoUpdate">
                                <option type="text" value="1">Positivo</option>
                                <option type="text" value="0">Neutro</option>
                                <option type="text" value="-1">Negativo</option>
                            </select>
...
<script type="text/javascript" src="inc/js/ajustes_motivos_js.js?version=<?php echo date("Y-m-d H:i:s"); ?>"></script>
