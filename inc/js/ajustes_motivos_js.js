...
$("#actualidarDatosAjustesMotivo").submit(function (event) {
    if (!requestSent) {
        requestSent = true;
        var parametros = {
            funcion: "updateAjustesMotivo",
            codigo: codigo,
            descripcion: $("#descripcionUpdate").val(),
            impacto: $("#impactoUpdate").val()
        }
        $.ajax({
            type: "POST",
            url: 'controller/ajustes_motivos.controller.php',
...
$("#guardarDatosAjustesMotivo").submit(function (event) {
    if (!requestSent) {
        requestSent = true;
        var parametros = {
            funcion: "addAjustesMotivo",
            descripcion: $("#descripcionAdd").val(),
            impacto: $("#impactoAdd").val()
        }
        $.ajax({
            type: "POST",
            url: 'controller/ajustes_motivos.controller.php',
