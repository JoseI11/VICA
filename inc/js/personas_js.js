...
$("#actualidarDatosPersona").submit(function (event) {
    if (!requestSent) {
        requestSent = true;
        var parametros = {
            funcion: "updatePersona",
            codigo: codigo,
            descripcion: $("#descripcionUpdate").val(),
            telefono: $("#telefonoUpdate").val(),
            localidad: $("#localidadUpdate").val(),
            cuit: $("#cuitUpdate").val(),
            mail: $("#mailUpdate").val(),
            pais: $("#paisUpdate").val(),
            provincia: $("#provinciaUpdate").val(),
            cliente: $("#clienteUpdate").val(),
            proveedor: $("#proveedorUpdate").val(),
            transportista: $("#transportistaUpdate").val(),
            vendedor: $("#vendedorUpdate").val(),
...
$("#guardarDatosPersona").submit(function (event) {
    if (!requestSent) {
        requestSent = true;
        var parametros = {
            funcion: "addPersona",
            descripcion: $("#descripcionAdd").val(),
            telefono: $("#telefonoAdd").val(),
            localidad: $("#localidadAdd").val(),
            cuit: $("#cuitAdd").val(),
            mail: $("#mailAdd").val(),
            pais: $("#paisAdd").val(),
            provincia: $("#provinciaAdd").val(),
            cliente: $("#clienteAdd").val(),
            proveedor: $("#proveedorAdd").val(),
            transportista: $("#transportistaAdd").val(),
            vendedor: $("#vendedorAdd").val(),
