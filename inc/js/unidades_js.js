...
$("#actualidarDatosUnidad").submit(function (event) {
    if (!requestSent) {
        requestSent = true;
        var parametros = {
            funcion: "updateUnidad",
            codigo: codigo,
            descripcion: $("#descripcionUpdate").val(),
            abreviatura: $("#abreviaturaUpdate").val()
        }
        $.ajax({
            type: "POST",
            url: 'controller/unidades.controller.php',
...
$("#guardarDatosUnidad").submit(function (event) {
    if (!requestSent) {
        requestSent = true;
        var parametros = {
            funcion: "addUnidad",
            descripcion: $("#descripcionAdd").val(),
            abreviatura: $("#abreviaturaAdd").val()
        }
        $.ajax({
            type: "POST",
            url: 'controller/unidades.controller.php',
