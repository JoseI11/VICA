...
include $_SERVER['DOCUMENT_ROOT'] . "/VICA/controller/comp_categorias.controller.php";
$controlador = CompCategoriasController::singleton_comp_categorias();

$_SESSION["totales"] = $controlador->getCountCompCategorias();
...
$_SESSION['menu'] = "comp_categorias.php";

$_SESSION['breadcrumb'] = "Componentes - Categorías";

$titlepage = "Componentes - Categorías";
...
<div class="container">
    ...
    <div class="modal fade" id="myModal" comp_categoria="dialog">
    ...
    <form id="guardarDatosCompCategoria">
        <div class="modal fade" id="dataRegister" tabindex="-1" comp_categoria="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" comp_categoria="document">
                <div class="modal-content">
                    <div class="modal-header">
    ...
    <form id="actualidarDatosCompCategoria">
        <div class="modal fade" id="dataUpdate" tabindex="-1" comp_categoria="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" comp_categoria="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<script type="text/javascript" src="inc/js/comp_categorias_js.js?version=<?php echo date("Y-m-d H:i:s"); ?>"></script>
