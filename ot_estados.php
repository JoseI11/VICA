...
include $_SERVER['DOCUMENT_ROOT'] . "/VICA/controller/ot_estados.controller.php";
$controlador = OtEstadosController::singleton_ot_estados();

$_SESSION["totales"] = $controlador->getCountOtEstados();
...
$_SESSION['breadcrumb'] = "OT - Estados";

$titlepage = "OT - Estados";
...
<div class="container">
    ...
    <div class="modal fade" id="myModal" ot_estado="dialog">
    ...
    <form id="guardarDatosOtEstado">
        <div class="modal fade" id="dataRegister" tabindex="-1" ot_estado="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" ot_estado="document">
                <div class="modal-content">
                    <div class="modal-header">
    ...
    <form id="actualidarDatosOtEstado">
        <div class="modal fade" id="dataUpdate" tabindex="-1" ot_estado="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" ot_estado="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
