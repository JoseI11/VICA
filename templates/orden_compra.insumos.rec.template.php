<table id="tabla" namefile="OrdenCompras" totales="<?php echo $_SESSION["totales"]; ?>" registros="<?php echo $_SESSION['cant_reg']; ?>" pagina="<?php $_SESSION['pagina']; ?>" class="table table-striped table-hover" mes="<?php echo $mes; ?>" anio="<?php echo $anio; ?>" dia="<?php echo $dia; ?>" opcion="<?php echo $opcion; ?>"> 
    <thead>
        <tr class="row " style="background-color: transparent;">
            ...
            <th class="col-lg-1 col-md-1 col-sm-1 col-xs-1 text-center ordena" orderby="precio" sentido="asc">Recibido</th>
    ...
    <tbody id="body">
        <?php foreach ($registros as $usu) { ?>
            <tr class="row" codigo="<?php echo $usu["codigo"]; ?>">
                ...
                <td class="col-lg-1 col-md-1 col-sm-1 col-xs-1 text-center noExl" style="vertical-align: middle;"><?php echo $usu["cantidad_recibida"]; ?></td>
                <td class="col-lg-1 col-md-1 col-sm-1 col-xs-1 text-center noExl" style="vertical-align: middle;">
                    <?php if ($oc["cod_orden_compra_estado"] == 2){ ?>
                        <div class="editOrdenCompra" style="text-align: center;"><a href="#"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a></div>
                    <?php } ?>
                </td>
            </tr>
<?php } ?>
    ...
    $(".editOrdenCompra").click(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#recibidoUpdate').val(datos.cantidad_recibida);
            },
            error: function () {
                alert("Error");
            }
