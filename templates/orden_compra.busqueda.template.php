...
<form id="guardarDatosOrdenCompra">
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="descripcion" name="descripcion" required maxlength="100" value="<?php echo $orden_compra["observaciones"]; ?>">
        </div>
        <div class="form-group" style="display: flex;">
            ...
            <input type="date" class="form-control" id="fecha" name="fecha" style="margin-left:1%; width: 20%;" maxlength="100" value="<?php echo $orden_compra["fecha"]; ?>">
            ...
            <select id="proveedor" style="margin-left:1%; width: 50%;" class="form-control" name="proveedor">
