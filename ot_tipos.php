...
include $_SERVER['DOCUMENT_ROOT'] . "/VICA/controller/ot_tipos.controller.php";
$controlador = OtTiposController::singleton_ot_tipos();

$_SESSION["totales"] = $controlador->getCountOtTipos();
...
$_SESSION['menu'] = "ot_tipos.php";

$_SESSION['breadcrumb'] = "OT - Tipos";
...
<div class="container">
    ...
    <div class="modal fade" id="myModal" ot_tipo="dialog">
    ...
    <form id="guardarDatosOtTipo">
        <div class="modal fade" id="dataRegister" tabindex="-1" ot_tipo="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" ot_tipo="document">
                <div class="modal-content">
                    <div class="modal-header">
    ...
    <form id="actualidarDatosOtTipo">
        <div class="modal fade" id="dataUpdate" tabindex="-1" ot_tipo="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" ot_tipo="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<script type="text/javascript" src="inc/js/ot_tipos_js.js?version=<?php echo date("Y-m-d H:i:s"); ?>"></script>
