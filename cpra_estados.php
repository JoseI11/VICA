...
include $_SERVER['DOCUMENT_ROOT'] . "/VICA/controller/cpra_estados.controller.php";
$controlador = CpraEstadosController::singleton_cpra_estados();

$_SESSION["totales"] = $controlador->getCountCpraEstados();
...
$_SESSION['menu'] = "cpra_estados.php";

$_SESSION['breadcrumb'] = "Compras - Estados";

$titlepage = "Compras - Estados";
...
<div class="container">
    ...
    <div class="modal fade" id="myModal" cpra_estado="dialog">
    ...
    <form id="guardarDatosCpraEstado">
        <div class="modal fade" id="dataRegister" tabindex="-1" cpra_estado="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" cpra_estado="document">
                <div class="modal-content">
                    <div class="modal-header">
    ...
    <form id="actualidarDatosCpraEstado">
        <div class="modal fade" id="dataUpdate" tabindex="-1" cpra_estado="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" cpra_estado="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<script type="text/javascript" src="inc/js/cpra_estados_js.js?version=<?php echo date("Y-m-d H:i:s"); ?>"></script>
