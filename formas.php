...
include $_SERVER['DOCUMENT_ROOT'] . "/VICA/controller/formas.controller.php";
$controlador = FormasController::singleton_formas();

$_SESSION["totales"] = $controlador->getCountFormas();
...
$_SESSION['menu'] = "formas.php";

$_SESSION['breadcrumb'] = "Formas";
...
<div class="container">
    ...
    <div class="modal fade" id="myModal" forma="dialog">
    ...
    <form id="guardarDatosForma">
        <div class="modal fade" id="dataRegister" tabindex="-1" forma="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" forma="document">
                <div class="modal-content">
                    <div class="modal-header">
    ...
    <form id="actualidarDatosForma">
        <div class="modal fade" id="dataUpdate" tabindex="-1" forma="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" forma="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<script type="text/javascript" src="inc/js/formas_js.js?version=<?php echo date("Y-m-d H:i:s"); ?>"></script>
