...
include $_SERVER['DOCUMENT_ROOT'] . "/VICA/controller/maq_modelos.controller.php";
$controlador = MaqModelosController::singleton_maq_modelos();

$_SESSION["totales"] = $controlador->getCountMaqModelos();
...
<div class="container">
    ...
    <div class="modal fade" id="myModal" maq_modelo="dialog">
    ...
    <form id="guardarDatosMaqModelo">
        <div class="modal fade" id="dataRegister" tabindex="-1" maq_modelo="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" maq_modelo="document">
                <div class="modal-content">
                    <div class="modal-header">
    ...
    <form id="actualidarDatosMaqModelo">
        <div class="modal fade" id="dataUpdate" tabindex="-1" maq_modelo="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" maq_modelo="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<script type="text/javascript" src="inc/js/maq_modelos_js.js?version=<?php echo date("Y-m-d H:i:s"); ?>"></script>
