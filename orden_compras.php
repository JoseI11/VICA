            ...
            <div class="modal-dialog" orden_compra="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group" id="BuscadorD" >
                            <label for="label0"  class="control-label ">Proveedor:</label>
                            <select id="proveedorAdd" class="form-control" name="proveedorAdd" style="width: 100%;">
...
<script type="text/javascript" src="inc/js/orden_compras_js.js?version=<?php echo date("Y-m-d H:i:s"); ?>"></script>
