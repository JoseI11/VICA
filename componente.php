...
$componente = $controlador->getComponenteArray(intval($_GET["codigo"]));
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group" style="display: flex;">
                            <label for="label0" class="control-label encabezado-form" style="margin-left:1%; margin-top:10px; width: 15%; text-align: right;">Insumo:</label>
                            <select id="insumoAdd" style="margin-left:1%; width: 30%;" class="form-control" name="insumoAdd">
...
<script type="text/javascript" src="inc/js/componente_js.js?version=<?php echo date("Y-m-d H:i:s"); ?>"></script>
