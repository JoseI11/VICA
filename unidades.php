...
include $_SERVER['DOCUMENT_ROOT'] . "/VICA/controller/unidades.controller.php";
$controlador = UnidadesController::singleton_unidades();

$_SESSION["totales"] = $controlador->getCountUnidades();
...
$_SESSION['menu'] = "unidades.php";

$_SESSION['breadcrumb'] = "Unidades";
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" id="btn-eliminar-unidad" name="btn-eliminar-unidad" class="btn btn-danger boton_marron_carni" data-dismiss="modal" >Eliminar</button>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="nombre0" class="control-label">Abreviatura:</label>
                            <input type="text" class="form-control" id="abreviaturaAdd" name="abreviaturaAdd" required maxlength="5">
                        </div>
                    </div>
                    <div class="modal-footer">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="nombre0" class="control-label">Abreviatura:</label>
                            <input type="text" class="form-control" id="abreviaturaUpdate" name="abreviaturaUpdate" required maxlength="5">
                        </div>
                    </div>
                    <div class="modal-footer">
...
<script type="text/javascript" src="inc/js/unidades_js.js?version=<?php echo date("Y-m-d H:i:s"); ?>"></script>
