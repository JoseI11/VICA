            ...
            <div class="modal-dialog" orden_compra="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="label0" class="control-label encabezado-form" >Precio:</label>
                            <input type="text" class="form-control" id="precioAdd" name="precioAdd"  maxlength="100">
                        </div>
                    </div>
                    <div class="modal-footer">
            ...
            <div class="modal-dialog" orden_compra="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="label0" class="control-label encabezado-form" >Precio:</label>
                            <input type="text" class="form-control" id="precioUpdate" name="precioUpdate"  maxlength="100">
                        </div>
                    </div>
                    <div class="modal-footer">
...
<script type="text/javascript" src="inc/js/orden_compra_js.js?version=<?php echo date("Y-m-d H:i:s"); ?>"></script>
