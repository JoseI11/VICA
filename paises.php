...
include $_SERVER['DOCUMENT_ROOT'] . "/VICA/controller/paises.controller.php";
$controlador = PaisesController::singleton_paises();

$_SESSION["totales"] = $controlador->getCountPaises();
...
$_SESSION['menu'] = "paises.php";

$_SESSION['breadcrumb'] = "Países";
...
<div class="container">
    ...
    <div class="modal fade" id="myModal" paise="dialog">
    ...
    <form id="guardarDatosPaise">
        <div class="modal fade" id="dataRegister" tabindex="-1" paise="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" paise="document">
                <div class="modal-content">
                    <div class="modal-header">
    ...
    <form id="actualidarDatosPaise">
        <div class="modal fade" id="dataUpdate" tabindex="-1" paise="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" paise="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<script type="text/javascript" src="inc/js/paises_js.js?version=<?php echo date("Y-m-d H:i:s"); ?>"></script>
